<?php
    ...
    $nSql = 'select * from paintings where series_id = 2 limit 9';
    $kSql = 'select * from paintings where series_id = 3 limit 9';
    ...
    # hardcodet names
    $series = [ 0 => 'Natur', 1 => 'Bäume', 2 => 'Köpfe'];
?>
        ...
        <?php
            for($i=0; $i<3; $i++){
                    ...
                    for($k=0; $k<3; $k++){
                        ...
                        echo "
                            <div class=\"col-lg py-2 py-lg-0\">
                                <div class=\"card\">
                                    <div id=\"cardImage\"><img $vertikal class=\"card-img-top shadowh\" src=\"static\pictures\detail\\$img\"></div>
                                    <div class=\"card-body\">
                                        <div class=\"row align-items-center\">
                                            ...
                                            <div class=\"col\">
                                                <span style=\"display: flex;flex-direction: row-reverse;\"><a href=\"mailto:name@bla.de?subject=Anfrage Bild #7\" class=\"btn btn-dark btn-sm pr-2 req\">mehr</a></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row py-lg-4">
				    <div class="col"> 
					    <div style="text-align: center"><a class="btn btn-success" href="#">mehr Bilder</a></div>
				    </div>
                </div>
